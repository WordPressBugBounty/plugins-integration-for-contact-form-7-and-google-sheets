...
?>
  ...
  <button type="submit" title="<?php esc_html_e('Search','integration-for-contact-form-7-and-spreadsheets') ?>" name="search_btn" class="button-secondary button crm_input_inline"><i class="fa fa-search"></i> <?php esc_html_e('Search','integration-for-contact-form-7-and-spreadsheets') ?></button> 
